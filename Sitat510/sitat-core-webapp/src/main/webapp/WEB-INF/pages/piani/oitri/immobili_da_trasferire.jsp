		...
		<c:when test='${!empty listaImmobiliDaTrasfInterv}'>
			<c:forEach items="${listaImmobiliDaTrasfInterv}" var="immobile" varStatus="indiceListaImmobiliDaTrasfInterv">
				<gene:gruppoCampi>
					...
					<gene:campoScheda title="Trasferimento immobile a titolo corrispettivo" entita="IMMTRAI"
						campoFittizio="true" 
						campo="TITCOR_${contatore}"
						value="${immobile[13]}" definizione="N7;0;PT013;T2TITCOR" />
					<gene:campoScheda title="Immobile disponibile art. 21-c5" entita="IMMTRAI"
						campoFittizio="true" 
						campo="IMMDISP_${contatore}"
						value="${immobile[14]}" definizione="N7;0;PT014;;T2IMMDIS" />
					<gene:campoScheda title="Gi&agrave; incluso in programma di dismissione art. 27 DL 201/2011" entita="IMMTRAI"
						campoFittizio="true" 
						campo="PROGDISM_${contatore}"
						value="${immobile[15]}" definizione="N7;0;PT015;;T2PROGDI" />
					<gene:campoScheda title="Tipo disponibilit&agrave;" entita="IMMTRAI"
						campoFittizio="true" 
						campo="TIPDISP_${contatore}"
						value="${immobile[16]}" definizione="N7;0;PT016;;T2TIPDIS" />
					<gene:campoScheda title="Valore stimato dell'immobile - Primo anno" entita="IMMTRAI"
						campoFittizio="true" 
						campo="VA1IMM_${contatore}"
						value="${immobile[17]}" definizione="F24.5;0;;MONEY;T2IVA1INT" />
					<gene:campoScheda title="Valore stimato dell'immobile - Secondo anno" entita="IMMTRAI"
						campoFittizio="true" 
						campo="VA2IMM_${contatore}"
						value="${immobile[18]}" definizione="F24.5;0;;MONEY;T2IVA2INT" />
					<gene:campoScheda title="Valore stimato dell'immobile - Terzo anno" entita="IMMTRAI"
						campoFittizio="true" 
						campo="VA3IMM_${contatore}"
						value="${immobile[19]}" definizione="F24.5;0;;MONEY;T2IVA3INT" />						
					<gene:campoScheda title="Valore stimato dell'immobile - Annualità successive" entita="IMMTRAI"
						campoFittizio="true" 
