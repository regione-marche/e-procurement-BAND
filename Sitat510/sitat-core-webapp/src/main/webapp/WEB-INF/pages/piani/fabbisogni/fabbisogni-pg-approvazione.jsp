...
<table class="dettaglio-tab-lista">
	<tr>
		<td><gene:formLista entita="PTAPPROVAZIONI" pagesize="20" sortColumn="3" tableclass="datilista" gestisciProtezioni="true"
...
<div id="DIV_NOTEAPPR_DESCR" class="ui-widget ui-widget-content ui-corner-all" style="position:absolute; width:388px; height:180px; z-index:99999; display:none;">
	...
	<gene:javaScript>
		...
		$("[id^='OVER200_']").mouseover(function() {			
			$(this).css('cursor', 'pointer');
		});
			
		$("[id^='OVER200_']").click(function() {			
