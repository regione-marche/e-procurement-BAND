...
<gene:template file="popup-template.jsp" gestisciProtezioni="true" schema="PIANI" idMaschera="listaInterventi">
	...
	<c:choose>
		<c:when test="${! empty listaAnnualitaInterventiProgPrecedenti}" >
			var temp = "GetListaInterventiDaProgrammaPrecedente.do?codiceProgramma=${param.codiceProgramma}&numeroPopUp=1";
		</c:when>
		<c:otherwise>
			var temp = "GetListaInterventiDaProgrammaPrecedente.do?codiceProgramma=${param.codiceProgramma}&tipo=INR&numeroPopUp=1";
		</c:otherwise>
	</c:choose>
