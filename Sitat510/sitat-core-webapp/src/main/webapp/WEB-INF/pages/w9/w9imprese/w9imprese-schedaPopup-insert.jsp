...
<gene:template file="scheda-template.jsp" gestisciProtezioni="true" schema="W9" 
	...
	function gestioneTipoPartecipante() {
		...
		if (tipoAgg != "") {
			...
			document.location.href = "${pageContext.request.contextPath}/ApriPagina.do?href=w9/w9imprese/w9imprese-schedaPopup-insert.jsp&modo=NUOVO&codGara=${param.codGara}&codLott=${param.codLott}&tipoImpresa="+tipoAgg;
		}
	}
	...
	<c:choose>
		<c:when test="${not empty param.numImpr and empty param.numRagg}">
			var href = "${pageContext.request.contextPath}/ApriPagina.do?href=w9/w9imprese/w9imprese-schedaPopup-insert.jsp&modo=MODIFICA&codGara=${param.codGara}&codLott=${param.codLott}&numImpr=${param.numImpr}&key=${param.key}";
			document.location.href = href;
		</c:when>
		<c:when test="${empty param.numImpr and not empty param.numRagg}">
			var href = "${pageContext.request.contextPath}/ApriPagina.do?href=w9/w9imprese/w9imprese-schedaPopup-insert.jsp&modo=MODIFICA&codGara=${param.codGara}&codLott=${param.codLott}&numRagg=${param.numRagg}&key=${param.key}";
			document.location.href = href;
		</c:when>
	</c:choose>
	}
