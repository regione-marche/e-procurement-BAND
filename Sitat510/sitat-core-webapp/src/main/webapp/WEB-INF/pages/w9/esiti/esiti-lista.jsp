							...
							<c:if test="${currentRow >= 0}">
								<gene:PopUp variableJs="rigaPopUpMenu${currentRow}" onClick="chiaveRiga='${chiaveRigaJava}'" >
									<gene:PopUpItemResource	resource="popupmenu.tags.lista.visualizza" title="Visualizza esito"
									 href="location.href = '${pageContext.request.contextPath}/ApriPagina.do?href=w9/w9pubblicazioni/w9pubblicazioni-scheda.jsp&key=${chiaveRigaJava}&tipoPubblicazione=${datiRiga.W9PUBBLICAZIONI_TIPDOC}'" />
								</gene:PopUp>
