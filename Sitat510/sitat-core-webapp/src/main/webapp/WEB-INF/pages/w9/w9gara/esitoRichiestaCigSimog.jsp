...
<gene:template file="scheda-template.jsp" >
	...
	<gene:javaScript>
		...
		function creaGara() {
			document.location.href="${pageContext.request.contextPath}/ApriPagina.do?href=w9/w9gara/richiestaIdAvGara.jsp&modo=NUOVO";
		}
	
		function creaLotto(idAvGara) {
			var strHref = "${pageContext.request.contextPath}/ApriPagina.do?href=w9/w9gara/richiestaCigSimog.jsp&modo=NUOVO";
			if (idAvGara != '')
