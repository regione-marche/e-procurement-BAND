...
<%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
	...
	<gene:formScheda entita="W9INIZ" gestisciProtezioni="true"
			...
			<gene:gruppoCampi idProtezioni="GEN">
				...
				<gene:campoScheda entita="W9MISSIC" campo="CODGARA"  where="W9MISSIC.CODGARA=W9INIZ.CODGARA and W9MISSIC.CODLOTT=W9INIZ.CODLOTT and W9MISSIC.NUM_MISS=W9INIZ.NUM_INIZ" visibile="false" value="${codgara}" defaultValue="${codgara}" />
				<gene:campoScheda entita="W9MISSIC" campo="CODLOTT"  where="W9MISSIC.CODGARA=W9INIZ.CODGARA and W9MISSIC.CODLOTT=W9INIZ.CODLOTT and W9MISSIC.NUM_MISS=W9INIZ.NUM_INIZ" visibile="false" value="${codglott}" defaultValue="${codlott}" />
				<gene:campoScheda entita="W9MISSIC" campo="NUM_MISS" where="W9MISSIC.CODGARA=W9INIZ.CODGARA and W9MISSIC.CODLOTT=W9INIZ.CODLOTT and W9MISSIC.NUM_MISS=W9INIZ.NUM_INIZ" visibile="${modoAperturaScheda ne 'NUOVO'}" />
				<gene:campoScheda entita="W9MISSIC" campo="DESCMIS"  where="W9MISSIC.CODGARA=W9INIZ.CODGARA and W9MISSIC.CODLOTT=W9INIZ.CODLOTT and W9MISSIC.NUM_MISS=W9INIZ.NUM_INIZ" /> 
				...
				<gene:archivio titolo="IMPRESE" obbligatorio="true"
						...
						<gene:campoScheda campo="CODIMP" visibile="false" from="W9INIZ" entita="W9MISSIC" where="W9MISSIC.CODGARA=W9INIZ.CODGARA and W9MISSIC.CODLOTT=W9INIZ.CODLOTT and W9MISSIC.NUM_MISS=W9INIZ.NUM_INIZ  AND W9MISSIC.CODIMP=IMPR.CODIMP" />
						<gene:campoScheda campo="NOMEST" entita="IMPR" from="W9MISSIC" where="W9MISSIC.CODGARA=W9INIZ.CODGARA and W9MISSIC.CODLOTT=W9INIZ.CODLOTT and W9MISSIC.NUM_MISS=W9INIZ.NUM_INIZ AND W9MISSIC.CODIMP=IMPR.CODIMP" title="Denom. Impresa Aggiudicataria" definizione="T61" />
				</gene:archivio>
			</gene:gruppoCampi>
			...
			<c:choose>	
				...
				<c:otherwise>
					<c:set var="tmp" value='${gene:callFunction5("it.eldasoft.w9.tags.funzioni.GestioneDocumentazioneFaseFunction", pageContext, codgara, codlott, "993", "1")}' />
					<jsp:include page="/WEB-INF/pages/commons/interno-scheda-multipla.jsp" >
						<jsp:param name="entita" value='W9DOCFASE'/>
						<jsp:param name="chiave" value='${gene:getValCampo(key, "CODGARA")};${gene:getValCampo(key, "CODLOTT")};993;1'/>
...
<gene:javaScript>   
	...
	var schedaConferma = function() {
		...
		if (continua) {
			document.forms[0].action = "${pageContext.request.contextPath}/w9/Scheda.do";
			tmpSchedaConferma();
		}
	}
