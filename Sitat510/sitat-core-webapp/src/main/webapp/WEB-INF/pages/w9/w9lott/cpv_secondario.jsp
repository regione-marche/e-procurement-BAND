...
<c:set var="keyW9LOTT" value="${keyW9LOTT}" scope="request"/>
	...
	<c:when test="${param.tipoDettaglio eq 1}">
		...
		<gene:campoScheda entita="W9CPV" campo="CPV_${param.contatore}" speciale="true" href="#" title="Codice CPV Secondario" value="${item[3]}" campoFittizio="true" definizione="T12;0;;;G2CPVCOD4" >
	...
	<c:otherwise>
		...
		<gene:campoScheda entita="W9CPV" campo="CPV_${param.contatore}" speciale="true" href="#" title="Codice CPV Secondario" campoFittizio="true" definizione="T12;0;;;G2CPVCOD4" >
			<gene:popupCampo titolo="Dettaglio CPV" href="formCPV()" />
		</gene:campoScheda>
