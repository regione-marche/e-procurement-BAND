	...
	<gene:redefineInsert name="corpo">
		...
		<table class="lista">
			<tr>
				<td><gene:formLista entita="W9FASI" pagesize="20" pathScheda="w9/w9flussi/inserimento-rettifica-flussi.jsp"
					...
					<c:set var="link"
						value='${gene:callFunction2("it.eldasoft.w9.tags.funzioni.GetRedirectFunction",pageContext,chiaveRigaJava)}' />
		...
		<gene:javaScript>
			...
			function paginaVisualizza(pag,keyup) {
				var action="${pageContext.request.contextPath}/ApriPagina.do?href=w9/" + pag; // + "?chiave=" + keyup;
