	...
	<gene:redefineInsert name="corpo">
		...
		<c:if test='${permessoUser lt 4}' >
			...
			<gene:gruppoCampi idProtezioni="GEN">
				...
				<gene:archivio titolo="IMPRESE" obbligatorio="true"
					...
					where="(IMPR.CODIMP in (select CODIMP from W9AGGI where CODGARA=${codgara} and CODLOTT=${codlott}) or IMPR.CODIMP in (select CODIMP from W9SUBA where CODGARA=${codgara} and CODLOTT=${codlott}))"
		...
		<!-- campi per  W9FASI-->
			<gene:campoScheda campo="CODGARA" entita="W9FASI" visibile="false" value="${codgara}"
				where="W9FASI.CODGARA = W9REGCON.CODGARA AND W9FASI.CODLOTT = W9REGCON.CODLOTT" />
