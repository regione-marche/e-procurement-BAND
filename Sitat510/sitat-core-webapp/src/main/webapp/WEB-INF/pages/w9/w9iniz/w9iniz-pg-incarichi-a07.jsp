...
<gene:formScheda entita="W9INIZ" gestisciProtezioni="true" plugin="it.eldasoft.w9.tags.gestori.plugin.GestoreW9INIZ"
	...
	<gene:campoScheda entita="W9INCA" campo="CODGARA" where="W9INCA.CODGARA=${codgara} and W9INCA.CODLOTT=${codlott} and W9INCA.NUM=${num}" visibile="false" value="${codgara}" />
	<gene:campoScheda entita="W9INCA" campo="CODLOTT" where="W9INCA.CODGARA=${codgara} and W9INCA.CODLOTT=${codlott} and W9INCA.NUM=${num}" visibile="false" value="${codlott}" />
	<gene:campoScheda entita="W9INCA" campo="NUM"     where="W9INCA.CODGARA=${codgara} and W9INCA.CODLOTT=${codlott} and W9INCA.NUM=${num}" visibile="false" value="${num}" />
	
	<!-- campi per  W9FASI-->
	<gene:campoScheda campo="CODGARA" entita="W9FASI" visibile="false" 
		where="W9FASI.CODGARA = W9INIZ.CODGARA AND W9FASI.CODLOTT = W9INIZ.CODLOTT" value="${codgara}"/>
	<gene:campoScheda campo="CODLOTT" entita="W9FASI" visibile="false"   
		where="W9FASI.CODGARA = W9INIZ.CODGARA AND W9FASI.CODLOTT = W9INIZ.CODLOTT" value="${codlott}"/>
	...
	<c:if test='${modo ne "NUOVO"}' >
		<gene:callFunction obj="it.eldasoft.w9.tags.funzioni.GetIncarichiProfessionaliFunction" parametro="${key};SEZIONE=T:IN;NUM_APPA=N:${num}" />
	</c:if>
