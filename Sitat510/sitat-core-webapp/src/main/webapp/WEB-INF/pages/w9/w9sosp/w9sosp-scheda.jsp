...
<gene:template file="scheda-template.jsp" gestisciProtezioni="true"	schema="W9" idMaschera="W9SOSP-scheda">
	...
	<gene:redefineInsert name="corpo">
			...
			<gene:campoScheda campo="CODGARA" entita="W9FASI" visibile="false" 
				where="W9FASI.CODGARA = W9SOSP.CODGARA AND W9FASI.CODLOTT = W9SOSP.CODLOTT" value="${codgara}"/>
			<gene:campoScheda campo="CODLOTT" entita="W9FASI" visibile="false"   
				where="W9FASI.CODGARA = W9SOSP.CODGARA AND W9FASI.CODLOTT = W9SOSP.CODLOTT" value="${codlott}"/>
