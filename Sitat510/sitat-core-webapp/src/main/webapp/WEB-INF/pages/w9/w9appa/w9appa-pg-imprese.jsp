	...
	<table class="dettaglio-tab-lista">
		...
		<tr>
			<td class="comandi-dettaglio" colSpan="2">	
				...
				<c:if test="${fn:length(risultatoListaW9Aggiudicatarie) eq 0 || ! empty isAccordoQuadro}">
	...
	<gene:javaScript>
		...
		function visualizza(chiave) {
			...
			if ("" == idGruppo) {
				...
				var href = "href=w9/w9appa/w9appa-pg-imprese-scheda.jsp&modo=VISUALIZZA&isW9FasePartecipante=" + isW9FasePartecipante + "&numImpr=" + numImpresa + "&key=" + tempKey;
				document.location.href = "${pageContext.request.contextPath}/ApriPagina.do?" + href;
			} else {
				// Apertura dettaglio di un gruppo di imprese
				var href = "href=w9/w9appa/w9appa-pg-imprese-scheda.jsp&modo=VISUALIZZA&isW9FasePartecipante=" + isW9FasePartecipante + "&numImpr=" + numImpresa + "&id_gruppo=" + idGruppo + "&key=" + tempKey;
				document.location.href = "${pageContext.request.contextPath}/ApriPagina.do?" + href;
			}
		}
		...
		function modifica(chiave){
			...
			if ("" == idGruppo) {
				...
				var href = "href=w9/w9appa/w9appa-pg-imprese-scheda.jsp&modo=MODIFICA&operazioneModificaAggi=1&numImpr=" + numImpresa + "&key=" + tempKey;
				document.location.href = "${pageContext.request.contextPath}/ApriPagina.do?" + href;
			} else {
				// Modifica dettaglio di un gruppo di imprese
				var href = "href=w9/w9appa/w9appa-pg-imprese-scheda.jsp&modo=MODIFICA&operazioneModificaAggi=1&numImpr=" + numImpresa + "&id_gruppo=" + idGruppo + "&key=" + tempKey;
				document.location.href = "${pageContext.request.contextPath}/ApriPagina.do?" + href;
			}
		}
		...
		function nuovo(){
			...
			if (isW9FasePartecipante != null && isW9FasePartecipante != "" && ${fn:length(risultatoListaW9Aggiudicatarie)} == 0){
				...
				document.location.href = "${pageContext.request.contextPath}/w9/ListaW9SelezionePartecipanti.do?" + href;
			} else {
				var tempKey = document.forms[0].keyParent.value ;
				var href = "href=w9/w9appa/w9appa-pg-imprese-scheda.jsp&modo=MODIFICA&key=" + tempKey + "&flusso=${flusso}";
				document.location.href = "${pageContext.request.contextPath}/ApriPagina.do?" + href;
			}
		}
