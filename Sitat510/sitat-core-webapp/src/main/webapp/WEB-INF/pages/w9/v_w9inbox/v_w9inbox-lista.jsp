...
<gene:template file="lista-template.jsp" gestisciProtezioni="true" schema="W9" idMaschera="W9INBOX-lista">
	...
	function eseguiImport(key, azione) {
		...
		if(continua)
			location.href = '${pageContext.request.contextPath}/w9/EseguiImportazioneOrt.do?idcomun=' + key + '&azione=' + azione;
	}
    ...
    function RifiutaRichiesta() {
      ...
      if ( valid ) {
	    location.href = "${pageContext.request.contextPath}/w9/EseguiImportazioneOrt.do?idcomun=" + keyRifiutata + "&azione=2&motivazione=" + motivazione.val();
		dialog.dialog( "close" );
      }
      return valid;
    }
