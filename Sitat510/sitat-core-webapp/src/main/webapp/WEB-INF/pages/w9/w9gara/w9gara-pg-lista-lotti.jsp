...
<c:choose>
	...
	<tr>
		<td>
			<gene:formLista entita="W9LOTT" pagesize="20"	tableclass="datilista" sortColumn="3" gestisciProtezioni="true"
				...
				<gene:campoLista campo="NLOTTO" headerClass="sortable"/>
...
<gene:javaScript>
	...
	function popolamentoMassivoSchede() {
		...
		document.location.href="${pageContext.request.contextPath}/ApriPagina.do?href=w9/w9lott/scelta-tipo-scheda.jsp?key=${key}";
	}
