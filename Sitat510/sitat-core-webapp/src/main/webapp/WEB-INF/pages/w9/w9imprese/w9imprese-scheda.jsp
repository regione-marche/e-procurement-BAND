...
<gene:template file="scheda-template.jsp" gestisciProtezioni="true" schema="W9" 
	...
	<c:choose>
		<c:when test="${empty locNumRagg}">
			var href = "${pageContext.request.contextPath}/ApriPagina.do?href=w9/w9imprese/w9imprese-scheda.jsp&modo=MODIFICA&codGara=${locCodGara}&codLott=${locCodLott}&numImpr=${locNumImpr}&key=${param.key}";
			document.location.href = href;
		</c:when>
		<c:when test="${not empty locNumRagg}">
			var href = "${pageContext.request.contextPath}/ApriPagina.do?href=w9/w9imprese/w9imprese-scheda.jsp&modo=MODIFICA&codGara=${locCodGara}&codLott=${locCodLott}&numImpr=${locNumImpr}&numRagg=${locNumRagg}&key=${param.key}";
			document.location.href = href;
		</c:when>
	</c:choose>
	}
