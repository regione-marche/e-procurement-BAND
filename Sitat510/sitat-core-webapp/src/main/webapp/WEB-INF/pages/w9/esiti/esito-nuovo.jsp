...
<gene:setString name="titoloMaschera" value='Compilazione di un nuovo esito' />
...
<gene:redefineInsert name="corpo">
	...
	<table class="dettaglio-notab">
		<tr>
			...
			<b>Pubblica un esito di un appalto / affidamento con CIG
		...
		<tr>
			...
			<br>
			<b>ATTENZIONE</b>: per inserire l'esito devi aver inserito prima l'anagrafica della gara/CIG; se non l'hai già fatto, ritorna indietro alla home page e inseriscila utilizzando i link:
			<br><br>
			<b>Compilazione di una nuova procedura di affidamento</b>
			<br>
			se non hai richiesto il CIG sul SIMOG (ad esempio nel caso di SmartCIG o altre casistiche particolari)
			<br><br>
			<b>Importa procedura di affidamento e lotti da SIMOG</b>
			<br>
			se hai richiesto il CIG sul SIMOG, per recuperare i dati senza doverli reinserire
			</td>
		</tr>
