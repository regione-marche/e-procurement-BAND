			...
			<gene:pagina title="Richiesta creazione CIG" >
				...
				<gene:formScheda entita="W9LOTT" gestore="it.eldasoft.w9.tags.gestori.submit.GestoreRichiestaCIG" >
					<gene:gruppoCampi idProtezioni="GEN">
						...
						<gene:campoScheda campo="LUOGO_NUTS" href="javascript:formNUTS(true,'W9LOTT_LUOGO_NUTS')" modificabile="false" speciale="true" obbligatorio="true" >
							<gene:popupCampo titolo="Dettaglio codice NUTS" href="formNUTS(true,'W9LOTT_LUOGO_NUTS')" />
						</gene:campoScheda>
