...
<gene:fnJavaScriptScheda
	funzione="bloccaCampoRuolo(${param.contatore}, '#W9AGGI_ID_TIPOAGG_${param.contatore}#')"
	elencocampi="W9AGGI_ID_TIPOAGG_${param.contatore}" esegui="true" />
<!--gene-:-fnJavaScriptScheda
	funzione="avvisoImpresaSingola(${param.contatore}, '#W9AGGI_ID_TIPOAGG_${param.contatore}#')"
	elencocampi="W9AGGI_ID_TIPOAGG_${param.contatore}" esegui="false" /-->
<gene:fnJavaScriptScheda
	funzione="bloccaCampoNomimp(${param.contatore}, '#W9AGGI_FLAG_AVVALIMENTO_${param.contatore}#')"
...
/* function avvisoImpresaSingola(idImpresa, valore) {
		if (valore != '') {
			if(valore == 3) {
					alert("ATTENZIONE! Selezionando 'Impresa singola', EVENTUALI ALTRE IMPRESE di tipologia differente NON SARANNO MEMORIZZATE.");
			}
		}
	} */
