	...
	<gene:javaScript>
		...
		function eseguiInvio(codgara, codlott, numxml, fase_esecuzione, num, idflusso) {
			if (confirm("Riprovare ad inviare il flusso selezionato?")) {
				location.href = '${pageContext.request.contextPath}/w9/EseguiInvioSchedaSimog.do?codgara=' + codgara + '&codlott=' + codlott + '&numxml=' + numxml + '&fase_esecuzione=' + fase_esecuzione + '&num=' + num + '&idflusso=' + idflusso;
			}
		}
