...
<gene:redefineInsert name="corpo">
	...
	<table class="dettaglio-notab">
		<tr>
			...
			<br>
			<b>La scheda è già stata inviata. Avviare un'instanza di cancellazione?
			<br><br>
			</td>
		</tr>		
		<tr class="comandi-dettaglio">
			<td class="comandi-dettaglio" colspan="2">
				...
				<input type="button" value="Si prosegui con la cancellazione" title="Si prosegui con la cancellazione" class="bottone-azione" onclick="javascript:paginaEliminaFase();"/>&nbsp;
			</td>
		</tr>
	</table>
