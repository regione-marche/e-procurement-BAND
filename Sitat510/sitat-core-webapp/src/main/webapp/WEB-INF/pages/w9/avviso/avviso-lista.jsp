...
<c:choose>
	...
	<c:otherwise>
  	...
  	<gene:formLista entita="AVVISO" where="AVVISO.CODEIN = '${sessionScope.uffint}' ${where1}" pagesize="20" tableclass="datilista" sortColumn="2" gestisciProtezioni="true" >
			...
			<c:if test='${gene:checkProt(pageContext, "COLS.VIS.W9.AVVISO.SYSCON")}'>
  ...
  <gene:javaScript>
		function trasferisciAvvisi() {
			...
			if (numeroOggetti == 0) {
				...
				location.href = '${pageContext.request.contextPath}/ApriPagina.do?href=w9/commons/trasferisci-appalto.jsp&procedura=avvisi&chiavi='+listaAvvisi;
			}
		}
  </gene:javaScript>
</gene:template>