...
<gene:formScheda entita="W9APPA" gestisciProtezioni="true"
	...
	<gene:campoScheda entita="W9FINA" campo="CODGARA"
		where="W9FINA.CODGARA = ${codgara} and W9FINA.CODLOTT = ${codlott} and W9FINA.NUM_APPA = ${numappa}"
		visibile="false" defaultValue="${datiRiga.W9APPA_CODGARA}" />
	<gene:campoScheda entita="W9FINA" campo="CODLOTT"
		where="W9FINA.CODGARA = ${codgara} and W9FINA.CODLOTT = ${codlott} and W9FINA.NUM_APPA = ${numappa}"
		visibile="false" defaultValue="${datiRiga.W9APPA_CODLOTT}" />
	<gene:campoScheda entita="W9FINA" campo="NUM_APPA"
		where="W9FINA.CODGARA = ${codgara} and W9FINA.CODLOTT = ${codlott} and W9FINA.NUM_APPA = ${numappa}"
		visibile="false" defaultValue="${datiRiga.W9FINA.NUM_APPA}" />
