...
<gene:formScheda entita="W9COLL" gestisciProtezioni="true" plugin="it.eldasoft.w9.tags.gestori.plugin.GestoreW9COLL" gestore="it.eldasoft.w9.tags.gestori.submit.GestoreW9COLL"
	...
	<gene:campoScheda campo="CODGARA" entita="W9FASI" visibile="false" 
		where="W9FASI.CODGARA = W9COLL.CODGARA AND W9FASI.CODLOTT = W9COLL.CODLOTT" value="${codgara}"/>
	<gene:campoScheda campo="CODLOTT" entita="W9FASI" visibile="false"   
		where="W9FASI.CODGARA = W9COLL.CODGARA AND W9FASI.CODLOTT = W9COLL.CODLOTT" value="${codlott}"/>
	...
	<c:if test='${modo ne "NUOVO"}' >
		<gene:callFunction obj="it.eldasoft.w9.tags.funzioni.GetIncarichiProfessionaliFunction" parametro="${key};SEZIONE=T:CO;NUM_APPA=N:${num}" />
	</c:if>
