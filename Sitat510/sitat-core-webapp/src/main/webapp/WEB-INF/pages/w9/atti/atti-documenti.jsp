...
<gene:template file="scheda-template.jsp">
	...
	<gene:redefineInsert name="head">
		...
		<script src="${pageContext.request.contextPath}/js/jquery-ui-1.11.2.min.js"></script>
...
function afterLoadTree() {
    ...
    .each(function(index, value) {
	  ...
	  $("#jstree2").jstree("close_all");
		...
		$("li#"+node.id).find("i:last span").remove(".mcontatore");
		$("li#"+node.id).find("i:last").append("<span class='mcontatore'>"
		+ nodiVisibili + "</span>");
		}
		else {
		$("li#"+node.id).find("i:last span").remove(".mcontatore");
