		...
		<gene:formScheda entita="W3SMARTCIG" gestisciProtezioni="true" gestore="it.eldasoft.sil.w3.tags.gestori.submit.GestoreW3SMARTCIG" 
		 plugin="it.eldasoft.sil.w3.tags.gestori.plugin.GestoreW3SMARTCIG" >
			...
			<gene:archivio titolo="Collaborazioni"
				...
				scheda=""
				where="w3aziendaufficio.azienda_cf = '${cfein}' and w3aziendaufficio.id in (select w3usrsyscoll.w3aziendaufficio_id from w3usrsyscoll, w3usrsys where w3usrsyscoll.syscon = w3usrsys.syscon and w3usrsyscoll.rup_codtec = '${datiRiga.W3SMARTCIG_RUP}')"
			...
			<gene:campoScheda campo="M_RICH_CIG" obbligatorio="true"/>
