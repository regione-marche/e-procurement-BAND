...
<gene:template file="popup-template.jsp">
	...
	<gene:redefineInsert name="corpo">
		<form action="${contextPath}/w3/RichiestaRequisiti.do" method="post" name="formRequisiti">
	...
	<gene:javaScript>
		...
		function richiestaRequisiti(){
			...
			var simogwsuser = document.formRequisiti.simogwsuser;
			if (simogwsuser.value == "") {
				alert("Inserire l'utente");
				invia = "false";
			}
			
			var simogwspass = document.formRequisiti.simogwspass;			
