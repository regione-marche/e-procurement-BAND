...
<gene:template file="lista-template.jsp" gestisciProtezioni="true"
	...
	<gene:redefineInsert name="corpo">
		...
		<table class="lista">
			<tr>
				<td><gene:formLista entita="W3USRSYS"  where="W3USRSYS.SYSCON = ${sessionScope.profiloUtente.id} AND W3USRSYS.RUP_CODTEC in (SELECT CODTEC FROM TECNI WHERE 1=1 '${filtroUffint}')" pagesize="20" sortColumn="2"
