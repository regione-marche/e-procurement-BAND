...
<c:choose>
	...
	<c:otherwise>
		<c:set var="where1" value=" V_W3GARE.CODEIN = '${sessionScope.uffint}' AND SYSCON = ${sessionScope.profiloUtente.id} " />
	</c:otherwise>
</c:choose>
...
<gene:template file="lista-template.jsp" gestisciProtezioni="true"
	...
	<gene:javaScript>
		...
		function listaNuovaGara(){
			document.location.href = '${pageContext.request.contextPath}/ApriPagina.do?href=w3/w3gara/w3gara-nuova.jsp';
		}
