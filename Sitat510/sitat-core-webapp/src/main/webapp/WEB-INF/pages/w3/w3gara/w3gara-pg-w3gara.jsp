...
<gene:formScheda entita="W3GARA" gestisciProtezioni="true"
	...
	<gene:archivio titolo="Collaborazioni"
		...
		scheda=""
		where="w3aziendaufficio.azienda_cf = '${cfein}' and w3aziendaufficio.id in (select w3usrsyscoll.w3aziendaufficio_id from w3usrsyscoll, w3usrsys where w3usrsyscoll.syscon = w3usrsys.syscon and w3usrsyscoll.rup_codtec = '${datiRiga.W3GARA_RUP_CODTEC}')"
	...
	<gene:campoScheda campo="NUMERO_LOTTI" obbligatorio="true" defaultValue="1" />
...
<gene:javaScript>
	...
	function gestioneRUP_CODTEC(value) {
		...
		var _sql = "w3aziendaufficio.azienda_cf = '${cfein}' and w3aziendaufficio.id in (select w3usrsyscoll.w3aziendaufficio_id from w3usrsyscoll, w3usrsys where w3usrsyscoll.syscon = w3usrsys.syscon and w3usrsyscoll.rup_codtec = '" + value + "')";
