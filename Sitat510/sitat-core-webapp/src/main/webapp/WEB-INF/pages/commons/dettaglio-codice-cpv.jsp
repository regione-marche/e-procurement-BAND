...
<gene:template file="popup-template.jsp">
	...
	<gene:javaScript>
		...
		function reloadCPV() {
			...
			document.location.href="${pageContext.request.contextPath}/ApriPagina.do?href=commons/dettaglio-codice-cpv.jsp&modo=MODIFICA&campo=${param.campo}&valore="+getValue("CPVCOD")+"&campoRange=${param.campoRange}&etichetta=${param.etichetta}";
		}
