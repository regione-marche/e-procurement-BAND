...
<gene:template file="popup-template.jsp">
	...
	<gene:javaScript>
		...
		function reloadCPV() {
			...
			document.location.href="${pageContext.request.contextPath}/ApriPagina.do?href=commons/descriz-codice-cpv.jsp&modo=MODIFICA&campo=${param.campo}&valore="+getValue("CPVCOD")+"&campoRange=${param.campoRange}&campoLabel=${param.campoLabel}&campoEtichetta=${param.campoEtichetta}&campoDescr=${param.campoDescr}&valoreDescr="+getValue("CPVDESC");
		}
