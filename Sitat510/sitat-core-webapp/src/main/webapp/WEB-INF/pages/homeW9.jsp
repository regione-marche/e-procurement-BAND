...
<c:choose>
	...
	<c:otherwise>
		<c:set var="filtroLivelloUtenteW3GARA" value="V_W3GARE.DATA_CONFERMA_GARA IS NULL AND ((V_W3GARE.TIPO_GARA='S' AND V_W3GARE.STATO_SIMOG<>2) OR (V_W3GARE.TIPO_GARA='G' AND V_W3GARE.STATO_SIMOG<>7 AND V_W3GARE.STATO_SIMOG<>6 AND V_W3GARE.STATO_SIMOG<>99)) AND (V_W3GARE.SYSCON = ${profiloUtente.id} OR V_W3GARE.RUP_CODTEC IN (SELECT RUP_CODTEC FROM W3USRSYS WHERE SYSCON = ${profiloUtente.id}))" />
	</c:otherwise>
</c:choose>
...
<c:if test='${gene:checkProt(pageContext, "FUNZ.VIS.ALT.W9.W9HOME.SA-ADMIN")}'>
	<script type="text/javascript">
		document.location.href = "${contextPath}/ApriPagina.do?href=gene/uffint/admin-uffint-trova.jsp";
	</script>
</c:if>

<c:if test='${gene:checkProt(pageContext, "FUNZ.VIS.ALT.W9.W9HOME.ORT-INBX")}'>
	<script type="text/javascript">
		document.location.href = "${contextPath}/ApriPagina.do?href=w9/w9inbox/w9inbox-home.jsp";
	</script>
</c:if>
...
<!--
		...
		function nuovoProgramma(tiprog) {
			location.href = '${pageContext.request.contextPath}/ApriPagina.do?href=piani/piatri/piatri-scheda.jsp&modo=NUOVO&tiprog='+tiprog+'&norma=2';
		}
		...
		function nuovoFabbisogno(tipint) {
			location.href = '${pageContext.request.contextPath}/ApriPagina.do?href=piani/fabbisogni/fabbisogni-scheda.jsp&modo=NUOVO&tipint='+tipint;
		}
		...
		//funzione di creazione nuovo programma triennale
		function nuovaGara() {
			location.href = '${pageContext.request.contextPath}/ApriPagina.do?href=w9/w9gara/w9gara-scheda.jsp&modo=NUOVO';
		}
		
		//funzione di Compilazione di un nuovo SmartCIG
		function nuovoSmartCig() {
			location.href = '${pageContext.request.contextPath}/ApriPagina.do?href=w9/w9gara/w9gara-scheda.jsp&modo=NUOVO&smartcig=si';
		}
		...
		function caricaLottiSIMOG(){
			location.href = '${pageContext.request.contextPath}/w9/ConsultaGara.do?metodo=inizializza';
		}
		
		function caricaLottiOR() {
			location.href = '${pageContext.request.contextPath}/w9/ImportaDatiDaOR.do?metodo=inizializza';
		}
		...
		function apriScadenziario() {
			document.location.href = '${pageContext.request.contextPath}/ApriPagina.do?href=w9/calendario/calendario.jsp';
		}
		...
		function nuovoAvviso() {
			location.href = '${pageContext.request.contextPath}/ApriPagina.do?href=w9/avviso/avviso-scheda.jsp&modo=NUOVO';
		}
		...
		function nuovoEsito() {
			location.href = '${pageContext.request.contextPath}/ApriPagina.do?href=w9/esiti/esito-nuovo.jsp';
		}
		
		function aggiungiAtti() {
			location.href = '${pageContext.request.contextPath}/ApriPagina.do?href=w9/atti/atti-nuovo.jsp';
		}
		...
		function trovaFabbisogniRds(){
			  // Eseguo la ricerca del fabbisogno
				...
				if ((document.getElementById("fabb1").checked == true )){
					...
					where = "(FABBISOGNI.STATO=3 OR FABBISOGNI.STATO=4 OR FABBISOGNI.STATO=21 OR FABBISOGNI.STATO=22)";
				...
				<c:if test="${gene:checkProtFunz(pageContext,'INS','SCHEDANUOVO') 
					...
					<tr>
						<td><br><br><b>
							...
							title="Importa gara e lotti da SIMOG">Importa gara e lotti da SIMOG</a></b>
						</td>
					</tr>
				</c:if>
						...
						<tr>
							<td><br><br>
								...
								<c:forEach items="${listaAvvisi}" var="valoriAvvisi" varStatus="status">
									...
									<td><a href="javascript:leggiNotifica(${valoriAvvisi[0]}, ${status.index});" ><img id="leggiNotifica${status.index}" src="${contextPath}/img/flag_verde.gif" title="Segna notifica come letta" ></a> &nbsp;
									${valoriAvvisi[1]} &nbsp; 
			...
			<form name="formfind" action="javascript:trova();" >
				<table align="left" class="arealayout" style="width: 600">
					...
					<tr>
						<td><br><br><b>
							<a class="link-generico" href="javascript:nuovaGara();"
								title="Crea una nuova gara">Compilazione di una nuova procedura di affidamento
							</a></b>
						</td>
					</tr>
					...
					<tr>
						<td><br><br>
							<b>
							<a class="link-generico" href="javascript:caricaLottiSIMOG();"
							title="Importa procedura di affidamento e lotti da SIMOG">Importa procedura di affidamento e lotti da SIMOG</a>
							</b>
						</td>
					</tr>
					</c:if>
					<tr>
						<td><br><br><b>
							<a class="link-generico" href="javascript:nuovoEsito();"
								title="Compilazione di un nuovo esito">Compilazione di un nuovo esito
							</a></b>
						</td>
					</tr>
					<tr>
