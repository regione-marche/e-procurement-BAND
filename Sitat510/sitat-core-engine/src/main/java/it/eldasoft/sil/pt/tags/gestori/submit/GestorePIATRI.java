  ...
  public void preInsert(TransactionStatus status, DataColumnContainer impl)
    ...
    //if (bretri == null || bretri.trim().equals("")) {
      if (tiprog.intValue() == 1) {
    	  ...
    	  if (!codiceId.endsWith("001") && impl.getData("PIATRI.DADOZI") != null && impl.getData("PIATRI.DAPTRI") == null ) {
    		  impl.getColumn("PIATRI.BRETRI").setValue(new JdbcParametro(JdbcParametro.TIPO_TESTO,
    	    			"Adozione dello schema della programmazione dei lavori " + anntri + "/" + (anntri+2)));
    	  } else if (!codiceId.endsWith("001") && impl.getData("PIATRI.DAPTRI") != null){
    		  impl.getColumn("PIATRI.BRETRI").setValue(new JdbcParametro(JdbcParametro.TIPO_TESTO,
    	...
    	if (!codiceId.endsWith("001") && impl.getData("PIATRI.DAPTRI") != null){
  		  impl.getColumn("PIATRI.BRETRI").setValue(new JdbcParametro(JdbcParametro.TIPO_TESTO,
