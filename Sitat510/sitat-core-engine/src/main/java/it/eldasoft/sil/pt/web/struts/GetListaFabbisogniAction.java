    ...
    protected ActionForward runAction(ActionMapping mapping, ActionForm form,
      ...
      try {
        ...
        if ("1".equals(tipoForm)) {
          ...
          String filtroCodeinAttivo = ConfigManager.getValore("it.eldasoft.pt.ImportaProposteFiltroCodeinAttivo");
          String filtroCodein= "";
          if("1".equals(filtroCodeinAttivo)) {
          ...
          listaFabbisogni = this.sqlManager.getListVector(
              ...
              new Object[] { new Long(0), new Long(4)}); //Raccolta fabbisogni: modifiche per prototipo dicembre 2018 //vedi Raccolta fabbisogni.docx (mail da Lelio 26/11/2018)
        } else {
          ;
        }
