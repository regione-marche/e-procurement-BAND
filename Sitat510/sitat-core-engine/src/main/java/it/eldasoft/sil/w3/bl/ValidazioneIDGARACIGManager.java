...
public class ValidazioneIDGARACIGManager {
  ...
  private HashMap<String, Object> validate(String entita, Long syscon,
    ...
    try {
      ...
      if ("W3GARA".equals(entita)) {
        ...
        this.validazioneW3LOTT(sqlManager, numgara, numlott, listaControlli);
        ...
        this.validazioneW3GARAREQ(sqlManager, numgara, numreq, listaControlli);
  ...
  private void validazioneW3GARA(SqlManager sqlManager, Long numgara,
    ...
    try {
      ...
      String selectW3GARAMERC = "select categoria " 
          + "from w3garamerc where numgara = ? and nummerc=1";
      ...
      if (datiW3GARA != null && datiW3GARA.size() > 0) {
        ...
        //Numero lotti
        Long numeroLotti = (Long) SqlManager.getValueFromVectorParam(
                datiW3GARA, 9).getValue();
        ...
        Long categoria = (Long)sqlManager.getObject(selectW3GARAMERC,
                new Object[] { numgara });
        if (categoria == null) {
            this.addCampoObbligatorio(listaControlli, "W3GARAMERC",
                "CATEGORIA", pagina);
  ...
  private void validazioneW3LOTT(SqlManager sqlManager, Long numgara,
      Long numlott, List<Object> listaControlli) throws GestoreException {
    ...
    try {
      ...
      if (datiW3LOTT != null && datiW3LOTT.size() > 0) {
        ...
        if (sceltaContraente == null) {
          this.addCampoObbligatorio(listaControlli, "W3LOTT",
        ...
        } else if (sceltaContraente.equals(new Long(4)) || sceltaContraente.equals(new Long(10))){
            ...
            if (!(countCond > 0)) {
              ...
              this.addAvviso(listaControlli, "W3COND", "Indicazione condizione obbligatoria", "E", pagina, "E' necessario indicare almeno un valore", "");
            }
        } 
        ...
        if (motivoCollegamento == null) {
        	...
        	if (isStringaValorizzata(prevedeRipetizioni) && prevedeRipetizioni.equals("1")){
        		...
        		String selectW3COND = "select ID_CONDIZIONE from w3cond where numgara = ? and numlott = ? and num_cond = 1";
