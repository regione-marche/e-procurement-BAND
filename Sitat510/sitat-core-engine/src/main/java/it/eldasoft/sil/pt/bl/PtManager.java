 ...
 */
  ...
  return codtec;
    ...
    * @throws GestoreException GestoreException
    */
     public void contrassegnaFabbisogno(String fabbisogni,String funzionalita)
             throws GestoreException {
         ...
         try {
             ...
             for (int i = 0; i < chiavi.length; i++) {
                 ...
                 if("RDS_ContrassegnaCompletato".equals(funzionalita)){ //Profilo RDS: contrassegna come completato --> imposta stato della proposta a 2
                 ...
                 }else if("RDS_SottoponiAdApprFinanz".equals(funzionalita)){ //Profilo RDS: sottoponi proposta ad approvazione finanziaria (RAF) --> imposta stato della proposta a 3                 
                     this.sqlManager.update(updateFABBISOGNI, new Object[] {new Long(3), conint });
                   ...
                   this.sqlManager.update(updateFABBISOGNI, new Object[] {new Long(22), conint });
                 }
               }                 
             ///////////////////////////////////////////////////////////////
             this.sqlManager.commitTransaction(status);
