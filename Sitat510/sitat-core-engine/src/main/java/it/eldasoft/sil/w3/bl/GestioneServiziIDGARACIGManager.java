...
if (logger.isDebugEnabled())
  ...
  public void aggiornaW3GARASTATO(Long numgara, Long stato)
    ...
    try {
      String updateW3GARA = "update w3gara set stato_simog = ? where numgara = ?";
      this.sqlManager.update(updateW3GARA, new Object[] { stato, numgara });
    ...
    if (errore != null) {
        ...
        throw new GestoreException(
            "Il servizio di invio requisiti ha risposto con il seguente messaggio: "
                + messaggio, "gestioneIDGARACIG.ws.inviorequisiti.error",
            new Object[] { messaggio }, null);
    }
 ...
 * @throws AxisFault 
  ...
  private SimogWSPDDServiceStub getSimogWS() throws ServiceException, GestoreException, AxisFault {
    ...
    String trustStore = ConfigManager.getValore(PROP_SIMOG_WS_TRUSTSTORE);
    String trustStorePassword = ConfigManager.getValore(
        PROP_SIMOG_WS_TRUSTSTOREPASSWORD);
