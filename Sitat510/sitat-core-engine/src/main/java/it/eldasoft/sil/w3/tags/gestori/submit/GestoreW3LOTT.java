...
public class GestoreW3LOTT extends AbstractGestoreChiaveNumerica {
  ...
  public void preDelete(TransactionStatus status, DataColumnContainer datiForm)
    ...
    this.getGeneManager().deleteTabelle(new String[] { "W3LOTTTIPI", "W3LOTTCUP", "W3LOTTCATE", "W3COND" },
  ...
  public void preUpdate(TransactionStatus status, DataColumnContainer datiForm)
    ...
    if (datiForm.isModifiedTable("W3LOTT") || datiForm.isModifiedTable("W3LOTTCUP") || isModifiedTipiAppalto) {
