...
public class GestoreW9FASI extends AbstractGestoreChiaveNumerica {
  ...
  throws GestoreException {
    ...
    Long codgara = impl.getColumn("W9FASI.CODGARA").getValue().longValue();
    Long codlott = impl.getColumn("W9FASI.CODLOTT").getValue().longValue();
    Long numeroFase = impl.getColumn("W9FASI.NUM").getValue().longValue();
    ...
    try {
      ...
      case CostantiW9.COMUNICAZIONE_ESITO:
        ...
        if (! UtilitySITAT.existsFase(codgara, codlott, CostantiW9.STIPULA_ACCORDO_QUADRO, this.sqlManager)) {
