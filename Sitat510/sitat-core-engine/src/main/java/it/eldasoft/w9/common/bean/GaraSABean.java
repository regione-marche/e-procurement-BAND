...
public class GaraSABean {
  ...
  /**
   * @return the codiciCigInSimog
   */
  public String[] getCodiciCigInSimog() {
    return codiciCigInSimog;
  }

  /**
   * @return the codiciCigInSimog[i]
   */
  public String getCodiceCigInSimog(int indice) {
    return codiciCigInSimog[indice];
  }
  
  /**
   * @param codiciCigInSimog the codiciCigInSimog to set
   */
  public void setCodiciCigInSimog(String[] codiciCigInSimog) {
    this.codiciCigInSimog = codiciCigInSimog;
  }
