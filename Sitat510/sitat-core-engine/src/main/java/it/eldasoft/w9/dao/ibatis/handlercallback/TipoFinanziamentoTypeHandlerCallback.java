 ...
 * it.maggioli.w9.pubblica.webservices.AppaltiLiguriaWebService.types.TipoFinanziamentoType.
 * 
 * @author Luca.Giacomazzo
 */
public class TipoFinanziamentoTypeHandlerCallback implements TypeHandlerCallback {
  ...
  public Object getResult(ResultGetter getter) throws SQLException {
    ...
    if (StringUtils.isNotEmpty(str)) {
      flag = TipoFinanziamentoType.fromString(str);
    }
    return flag;
  }
  ...
  public void setParameter(ParameterSetter setter, Object parameter) throws SQLException {
    ...
    if (parameter == null) { 
      ...
      setter.setString(((TipoFinanziamentoType) parameter).getValue());
    }
  }
  ...
  public Object valueOf(String str) {
    Object result = str;
    if (StringUtils.isNotEmpty(str)) {
      result = TipoFinanziamentoType.fromString(str);
    }
    return result;
  }
