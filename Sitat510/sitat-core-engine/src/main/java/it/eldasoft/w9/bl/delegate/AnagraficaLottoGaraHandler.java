...
public class AnagraficaLottoGaraHandler extends AbstractRequestHandler {
  ...
  private void insertDatiLotto(RichiestaRichiestaRispostaSincronaAnagraficaLottoGaraDocument doc,
    ...
    for (int i = 0; i < doc.getRichiestaRichiestaRispostaSincronaAnagraficaLottoGara().getListaTab5().sizeOfTab5TypeArray(); i++) {
      ...
      if (UtilitySITAT.existsFase(codGara, codLott, CostantiW9.AGGIUDICAZIONE_SOPRA_SOGLIA, this.sqlManager)
          || UtilitySITAT.existsFase(codGara, codLott, CostantiW9.FASE_SEMPLIFICATA_AGGIUDICAZIONE, this.sqlManager)
          || UtilitySITAT.existsFase(codGara, codLott, CostantiW9.ADESIONE_ACCORDO_QUADRO, this.sqlManager)) {
