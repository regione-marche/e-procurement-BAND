...
public class SaManager {
  ...
  public void insertAvviso(final Long codgara, final Long codlott, final String testonota) throws GestoreException, SQLException {
	  ...
	  dccG_NOTEAVVISI.addColumn("G_NOTEAVVISI.TITOLONOTA", JdbcParametro.TIPO_TESTO, "Richiesta cancellazione");
  ...
  /**
	 * Processo schedulata in SA che per ogni richiesta di eliminazione fatta 
									 ...
									 if (esito != null) {
										 if (esito.equals(it.toscana.rete.rfc.sitatsa.client.EsitoType.value2)) {
											 ...
											 try {
											   ...
											   insertAvviso( codgara, codlott, (risultato.getMessaggio() != null) ? risultato.getMessaggio(0) : "");
											 ...
											 try {
												 ...
												 //inserimento nota in G_NOTEAVVISI
											   	 this.insertAvviso( codgara, codlott, (risultato.getMessaggio() != null)?risultato.getMessaggio(0):"" );
												 commitTransaction = true;
											 } catch(SQLException e) {
