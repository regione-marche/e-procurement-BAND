...
public class CreazioneXmlExportManager {
  ...
  public static XmlObject getXmlGaraLottoFasi(GaraLottoBean garaLottoBean,
    ...
    case CostantiW9.GARE_ENTI_NAZIONALI_O_SOTTO_40000: // Gare per enti nazionali o inferiori a 40.000 euro 983
      xmlObject = CreazioneXmlExportManager.getRichiestaRispostaSincronaGaraEnteNazionaleSotto40000Document(
          garaLottoBean, sqlManager, w9Manager);
      break;
  ...
  private static RichiestaRichiestaRispostaSincronaGaraEnteNazionaleSotto40000Document
    ...
    CreazioneXmlExportManager.valorizzaTab31Type(richiestaGaraEntiNazSotto40000.addNewTab31(),
        codiceGara, sqlManager, w9Manager);
    CreazioneXmlExportManager.valorizzaListaTab311Type(richiestaGaraEntiNazSotto40000,
        codiceGara, sqlManager, w9Manager);
    CreazioneXmlExportManager.valorizzaTab312Type(richiestaGaraEntiNazSotto40000,
        codiceGara, sqlManager, w9Manager);
  ...
  throws SQLException, ParseException {
    ...
    CreazioneXmlExportManager.valorizzaArch1Type(arch1, codein, sqlManager);
  }
