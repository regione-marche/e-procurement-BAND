	...
	<gene:redefineInsert name="corpo">
			<div class="contenitore-arealavoro">
				...
				<div class="dettaglio-home">
				  ...
				  fare proposte, o semplicemente esprimere le vostre opinioni, potete contattarci all'indirizzo email:
				  <a href="mailto:osservatorio_regionale.llpp@regione.marche.it" class="link-generico">osservatorio_regionale.llpp@regione.marche.it</a>
				  </div>
				</div>
