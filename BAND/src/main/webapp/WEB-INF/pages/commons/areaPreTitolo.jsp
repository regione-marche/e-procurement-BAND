...
<c:set var="isNavigazioneDisattiva" value="${isNavigazioneDisabilitata}" />
		...
		<div class="over-hidden">
			...
			<div class="info-utente">
				...
				<c:if test="${empty param.hideOpzioni && ((empty isNavigazioneDisattiva) or (isNavigazioneDisattiva ne '1'))}">
				...
				| <A id="idUtLogEsci" href="javascript:utLogEsci();" tabindex="1500" class="link-generico">Esci</A></c:if>
			  </div>
		</div>
